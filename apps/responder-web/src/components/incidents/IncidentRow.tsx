...
export function IncidentTableRow({ incident, isSelected, onSelect }: IncidentRowProps) {
  ...
  return (
    ...
    >
      ...
      <td className="px-3 py-2 text-sm text-ink-900">{CATEGORY_LABELS[incident.details?.category]}</td>
...
export function IncidentCard({ incident, isSelected, onSelect }: IncidentRowProps) {
  ...
  return (
    ...
    >
      ...
      <p className="text-sm font-medium text-ink-900">{CATEGORY_LABELS[incident.details?.category]}</p>
